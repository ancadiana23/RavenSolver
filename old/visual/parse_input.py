...
if __name__ == '__main__':
    ...
    problem_dir = '../../Data/Problem_images/resized'
    problem_txt_dir = '../../Data/Problems_txt'
    output_dir = '../../Data/Problems_try'

    if args.parse:
        problems = []
        index = 0

        folder_name = '../../Data/Problem_images/resized'
        for file_name in os.listdir(folder_name):
            ...
            csv_file = os.path.join("../../Data/CSV_Problems", str(index) + '.csv')
            index += 1
    ...
    if args.sdrs:
        write_problems_with_sdrs(output_dir, '../../Data/Problems_sdr')
